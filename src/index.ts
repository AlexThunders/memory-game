...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let cards = Array.from(document.querySelectorAll('.card')) as HTMLDivElement[];
  let game = document.querySelector('.memory-game') as HTMLDivElement;
  ...
  let timer: any;
  let checkAll = false;
  let start = document.querySelector('#start') as HTMLAnchorElement;
  let instruction = document.getElementById('instruction') as HTMLDivElement;
  ...
  function flip(this: HTMLDivElement) {
  ...
  congrats.style.background = "url(../assets/fireworks.gif)"
  congrats.style.backgroundSize = "cover";
  congrats.style.backgroundRepeat = "no-repeat";
  congrats.style.backgroundPosition = "center";
